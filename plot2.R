plot2 <- function() {
  ...
  # 3 , create the plot
  par(mfrow = c(1,1))
  with(powerConsumptionDataSubset, plot(powerConsumptionDataSubset$dt, powerConsumptionDataSubset$Global_active_power, type = "l", main = "", xlab = "", ylab = "Global Active Power (kilowatts)"))
